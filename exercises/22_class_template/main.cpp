            ...
            for (unsigned int j = 0; j < shape[1]; ++j) {
                for (unsigned int k = 0; k < shape[2]; ++k) {
                    for (unsigned int l = 0; l < shape[3]; ++l) {
                        const unsigned int idx_others[4] = {
                            others.shape[0] == 1 ? 0 : i,
                            others.shape[1] == 1 ? 0 : j,
                            others.shape[2] == 1 ? 0 : k,
                            others.shape[3] == 1 ? 0 : l
                        };
                        const unsigned int others_index = 
